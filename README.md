...
[![Build Status](https://travis-ci.org/cytopia/docker-percona-5.5.svg?branch=master)](https://travis-ci.org/cytopia/docker-percona-5.5) [![](https://images.microbadger.com/badges/version/cytopia/percona-5.5.svg)](https://microbadger.com/images/cytopia/percona-5.5 "percona-5.5") [![](https://images.microbadger.com/badges/image/cytopia/percona-5.5.svg)](https://microbadger.com/images/cytopia/percona-5.5 "percona-5.5") [![](https://images.microbadger.com/badges/license/cytopia/percona-5.5.svg)](https://microbadger.com/images/cytopia/percona-5.5 "percona-5.5")

[![cytopia/percona-5.5](http://dockeri.co/image/cytopia/percona-5.5)](https://hub.docker.com/r/cytopia/percona-5.5/)

**[mysql 5.5](https://github.com/cytopia/docker-mysql-5.5) | [mysql 5.6](https://github.com/cytopia/docker-mysql-5.6) | [mysql 5.7](https://github.com/cytopia/docker-mysql-5.6) | [mysql 8.0](https://github.com/cytopia/docker-mysql-8.0) | [mariadb 5.5](https://github.com/cytopia/docker-mariadb-5.5) | [mariadb 10.0](https://github.com/cytopia/docker-mariadb-10.0) | [mariadb 10.1](https://github.com/cytopia/docker-mariadb-10.1) | [mariadb 10.2](https://github.com/cytopia/docker-mariadb-10.2) | [mariadb 10.3](https://github.com/cytopia/docker-mariadb-10.3) | percona 5.5 | [percona 5.6](https://github.com/cytopia/docker-percona-5.6) | [percona 5.7](https://github.com/cytopia/docker-percona-5.7)**

----

**PerconaDB 5.5 Docker on CentOS 7**
...
mysqld  Ver 5.5.57-38.9 for Linux on x86_64 (Percona Server (GPL), Release 38.9, Revision fc6d4f87a88)
